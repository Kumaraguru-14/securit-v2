...
const ContactInfo = () => {
  return (
    <section
      className="pt-28 pb-14 sm:pt-28 md:pt-32 md:pb-16 lg:pb-20 xl:pt-[180px] xl:pb-[100px] bg-white">
      <div className="main-container">
        <div className="space-y-[50px]">
          <div className='mb-10 grid grid-cols-12 space-y-8 md:gap-8 md:space-y-0 xl:mb-18'>
            <div className='col-span-12 md:col-span-6 lg:col-span-6'>
              <span className="uppercase text-primary-500 tracking-[3px] text-sm">Contact Us</span>
              <h2 className="mb-3 font-bold text-primary-700">Get in touch with Us</h2>
              ...
              <div className="flex flex-col items-center justify-center gap-10 lg:flex-row lg:items-start lg:gap-8 xl:gap-[70px]">
                ...
                <div className="flex flex-col gap-8 md:flex-row lg:flex-col">
                  {/* {contactInfoItems.map((item) => (
                    <div key={item.id} className="bg-secondary dark:bg-background-6 relative w-full space-y-6 overflow-hidden rounded-[20px] p-11 text-center md:max-w-[371px]">
            ...
            <div className='col-span-12 md:col-span-6 lg:col-span-6'>
              {/* contact form  */}
              <div
                className="dark:bg-background-6 mx-auto w-full max-w-[847px] rounded-4xl bg-blue-light p-6 md:p-8 lg:p-11">
